...
def train_pipeline(
    ...
    download = dsl.ContainerOp(
        name="SynthDet download",
        image=docker_image,
        command=["python", "-m", "datasetinsights.scripts.synthdet_download"],
        arguments=[f"--verbose", f"--source-uri={source_uri}"],
    ...
    train = dsl.ContainerOp(
        ...
        arguments=[
            ...
            "train.epochs",
            epochs,
            "train.dataset.args.load_local",
            True,
            "val.dataset.args.load_local",
            True,
        ],
