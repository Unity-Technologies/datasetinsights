...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=b'\n\x1astring_int_label_map.proto"U\n\x15StringIntLabelMapItem\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\n\n\x02id\x18\x02 \x01(\x05\x12\x14\n\x0c\x64isplay_name\x18\x03 \x01(\t\x12\x0c\n\x04path\x18\x04 \x01(\t"9\n\x11StringIntLabelMap\x12$\n\x04item\x18\x01 \x03(\x0b\x32\x16.StringIntLabelMapItem',
)
...
_STRINGINTLABELMAPITEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="StringIntLabelMapItem.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="StringIntLabelMapItem.id",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="display_name",
            full_name="StringIntLabelMapItem.display_name",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="path",
            full_name="StringIntLabelMapItem.path",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
...
_STRINGINTLABELMAP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="item",
            full_name="StringIntLabelMap.item",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
