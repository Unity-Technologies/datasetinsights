...
class SynDetection2D(Dataset):
    ...
    def _preprocess_dataset(data_path):
        """ Preprocess dataset inside data_path and unarchive if necessary."""
        ...
        # This is for dataset stored in a single zip file.
        # In this case, all data are downloaded to a single zip file under
        # data_path. We will unarchive this path and change the data_path
        # to the un-archived folder
